    ...
    <BrowserRouter>
      <Routes>
        <Route path="" element={<HomeTemplate />}>
          ...
          <Route
            path="signin"
            element={isVerification() ? <Infor /> : <Login />}
          ></Route>
          <Route
            path="signup"
            element={isVerification() ? <Infor /> : <SignUp />}
          ></Route>
          <Route
            path="profile"
            element={isVerification() ? <Infor /> : <Login />}
          ...
          <Route
            path="admin"
            element={isAdmin() ? <Admintemplate /> : <Login />}
          >
            <Route path="/admin" element={<UserManage />}></Route>
            <Route path="/admin/" element={<UserManage />}></Route>
            <Route path="/admin/usermanage" element={<UserManage />}></Route>
            <Route
              path="/admin/locationinfomanage"
              element={<LocationInfoManage />}
            ></Route>
            <Route
              path="/admin/reservationmanage"
              element={<ReservationManage />}
            ></Route>
            <Route
              path="/admin/roominfomanage"
              element={<RoomInfoManage />}
            ></Route>
          </Route>
