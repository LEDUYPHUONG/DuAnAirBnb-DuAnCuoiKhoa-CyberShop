...
import { postEditImageRoomAdminApi } from "../../../redux/reducer/adminRoomInfoManageReducer";

type Props = {
    id: number
  }
function ModalUpdateImageRoomAdmin({id}: Props) {
        ...
        <Modal.Body>
          <form 
            ...
            onSubmit={(event) => {
              ...
              dispatch(postEditImageRoomAdminApi(values.maViTri,formData));
          }}
         >
            <div className="sign_up mt-0 p-3" style={{borderRadius:"20px"}}>
              <div style={{borderRadius:"20px"}}>
                <div className="bg_cover d-flex flex-column align-items-center justify-content-center" style={{borderRadius:"20px"}}>
                  <h2 style={{ fontSize:'28px'}}>UPDATE IMAGE'S ROOM</h2>
...
export default ModalUpdateImageRoomAdmin;
