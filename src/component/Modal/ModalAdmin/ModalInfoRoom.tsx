              ...
              >
                ...
                >
                  ...
                  <div className="signup_input w-100 px-3">
                    <p className="text-dark input-group-text text-wrap text-start">
                      ID: {item.id}
                    </p>
                    <p className="text-dark input-group-text text-wrap text-start">
                      Name room: {item.tenPhong}
                    </p>
                    <p className="text-dark input-group-text text-wrap text-start ">
                      Guest: {item.khach}
                    </p>
                    ...
                    <p className="text-dark input-group-text text-start text-wrap">
                      Describe: {item.moTa}
                    </p>
                    <p className="text-dark input-group-text text-wrap text-start">
                      Price: {item.giaTien}
