...
import { postEditImageLocationAdminApi } from "../../../redux/reducer/adminLocationReducer";

type Props = {
    id: number
  }
function ModalUpdateImageLocationAdmin({id}: Props) {
  ...
  const formik = useFormik({
    ...
    validationSchema: Yup.object().shape({
      formFile: Yup.mixed().test("fileSize", "The file is too large", (value) => {
        ...
        <Modal.Body>
          <form 
            ...
            onSubmit={(event) => {
              ...
              dispatch(postEditImageLocationAdminApi(values.maViTri,formData));
          }}
         >
            <div className="sign_up mt-0 p-3" style={{borderRadius:"20px"}}>
              <div style={{borderRadius:"20px"}}>
                <div className="bg_cover d-flex flex-column align-items-center justify-content-center" style={{borderRadius:"20px"}}>
                  <h2 style={{ fontSize:'28px'}}>UPDATE IMAGE'S LOCATION</h2>
...
export default ModalUpdateImageLocationAdmin;
