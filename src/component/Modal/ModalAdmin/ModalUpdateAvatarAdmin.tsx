      ...
      >
        <Modal.Body>
          <form 
            ...
            // chưa có API để đổi avata của user hoặc admin trong  trang admin, muốn đổi phải log vào acc người đó, vào trang profile rồi đổi avatar
...
export default ModalUpdateAvatarAdmin;
