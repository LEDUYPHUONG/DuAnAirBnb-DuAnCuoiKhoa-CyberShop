...
function ModalEditRoom({ item }: Props) {
  ...
  const formik = useFormik({
    ...
    validationSchema: Yup.object().shape({
      tenPhong: Yup.string().required("Tên phòng đang trống"),
      khach: Yup.number()
      ...
      moTa: Yup.string().required("Mô tả đang trống"),
      giaTien: Yup.number()
      ...
      <Modal show={show} onHide={handleClose} keyboard={false}>
        <Modal.Body className="bg-dark rounded-2">
          <div className="bg-white rounded-3">
            <div
              className="shadow-lg p-3bg-body rounded"
            ...
            >
              ...
              >
                ...
                >
                  <h2
                    className="pt-3 fw-semiBold text-danger"
                    style={{ fontSize: "25px" }}
                  >
                    EDIT ROOM
                  </h2>
                  <div className="signup_input w-100 px-3">
                    ...
                    <p className="text-dark text-center fw-bold mt-2">
                      Image link
                    </p>
                    <div className="input-group mt-3">
