...
export default function MapHome() {
  return (
    <div className='vw-100 vh-100'>
      ...
      <div>
        <iframe width="100%" height="780px)" title='map home' frameBorder={0} scrolling="no" marginHeight={0} marginWidth={0} src="https://www.google.com/maps/ms?msid=204293175747830583907.0005022420ef3bca6a816&msa=0&ie=UTF8&t=m&ll=40.79042,-73.945541&spn=0.462677,1.056747&output=embed" />
      </div>
