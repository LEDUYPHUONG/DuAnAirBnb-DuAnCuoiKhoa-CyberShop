...
export default function RoomListItem({ product }: Props) {
  return (
    ...
    >
      ...
      >
        <img className="w-100 h-100" src={product.hinhAnh} alt="..." />
      </div>
      ...
      <div className="roomlist-item_des mt-3">
        <p style={{ color: "#746b6b", margin: "0px 0px" }}>
          Sức chứa: {product.khach} Khách
        </p>
        <p style={{ color: "#746b6b", margin: "0px 0px" }}>
          Số phòng ngủ: {product.phongNgu}
        </p>
        <p style={{ color: "#746b6b", margin: "0px 0px" }}>
          Số giường: {product.giuong}
        </p>
        <p
          className="text-truncate"
          style={{ color: "#746b6b", margin: "0px 0px" }}
        >
          Mô tả: {product.moTa}
        </p>
        <p style={{ color: "#746b6b", margin: "0px 0px" }}>
      ...
      >
        <span style={{ fontSize: 15, color: "#000000", fontWeight: "bold" }}>
          ${product.giaTien}
        </span>
        <span style={{ marginLeft: 3, fontWeight: 400, color: "#000000" }}>
          đêm
        </span>
      </div>
      <div
