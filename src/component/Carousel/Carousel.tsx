...
export default function Carousel() {
  ...
  const handleClickSetArrproduct = (itemClick: ArrIconCarousel) => {
    ...
    if (itemClick.srcId !== "00" && itemClick.title !== "") {
      dispatch(
        setKeyword(`pageIndex=1&pageSize=20&keyword=${itemClick.title}`)
      );
    }
  };
      ...
      return (
        <div key={index}>
          <div
            ...
            style={{ height: "80px", opacity: 0.6, cursor: "pointer" }}
            onClick={() => {
          ...
          >
            <img
              width={24}
              height={24}
              src={`./img/home/iconcarousel/iconA${item.srcId}.jpg`}
              alt="..."
            />
            <span
              className="d-block"
    ...
    return (
      <div
        ...
        style={{
          ...
          backgroundImage: `url("./img/home/nextIcon.png")`,
    ...
    return (
      <div
        ...
        style={{
          ...
          display: "block",
          boxShadow: "0 2px 4px rgba(0,0,0,0.18)",
          backgroundImage: `url("./img/home/prevIcon.png")`,
          backgroundRepeat: "no-repeat",
          backgroundSize: "cover",
          width: "40px",
          height: "40px",
