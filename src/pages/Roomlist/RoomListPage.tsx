...
export default function RoomListPage ({title}: Props) {
  ...
  const {arrRoomlist} = useSelector((state:RootState) => state.roomlistReducer)
  ...
  return (
    <>
      ...
      <div className='d-flex justify-content-between align-items-center' style={{ position: 'static', bottom: 0, left: 0, height: "47px", background: '#ffffff', border: "1px solid #cccccc", width: "100%", padding: "16px 48px", fontSize: "16px", lineHeight: "16px", zIndex: 10 }}>
