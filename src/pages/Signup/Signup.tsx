...
export default function Login({}: Props) {
  ...
  const frm = useFormik({
    ...
    validationSchema: Yup.object().shape({
      ...
      name: Yup.string()
      .required("Tên của bạn đang trống"),
      phone: Yup.string()
        ...
        <div className="sign_up_right">
          <div className="bg_cover d-flex flex-column align-items-center justify-content-center">
            ...
            <div className="signup_input d-flex flex-column  align-items-center">
              ...
              <span className="text-danger">{frm.errors.retype_password}</span>
              <input
                type="text"
                id="name"
              ...
              <DatePicker bordered={false} placeholder="Sinh nhật" format="DD/MM/YYYY" />
            </div>
            <div className="action_btn d-flex flex-column align-items-center">
              ...
              <span>
                Đã có tài khoản?
                <NavLink className="login_navigate" to={"/login"}>
                  Đăng nhập tại đây
                </NavLink>
              </span>
            </div>
